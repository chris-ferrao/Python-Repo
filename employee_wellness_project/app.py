...
def summary():
    ...
    kpi_benefits_uplift = an.get_kpi_uplift_from_benefits()
    kpi_remote_share = an.get_kpi_remote_share()
    ...
    heatmap = an.plot_heatmap_treatment_by_size_and_interference()
    gender_grouped = an.plot_grouped_bar_gender_x_treatment()
    remote_donut = an.plot_donut_remote_vs_treatment()
    leave_stack = an.plot_leave_accessibility_distribution()
    ...
    gender_grouped_html = gender_grouped.to_html(full_html=False, include_plotlyjs='cdn')
    remote_donut_html = remote_donut.to_html(full_html=False, include_plotlyjs='cdn')
    leave_stack_html = leave_stack.to_html(full_html=False, include_plotlyjs='cdn')
    ...
    return render_template('summary_dashboard.html',
                           ...
                           kpi_fear=kpi_fear,
                           kpi_benefits_uplift=kpi_benefits_uplift,
                           kpi_remote_share=kpi_remote_share,
                           ...
                           gender_grouped=gender_grouped_html,
                           remote_donut=remote_donut_html,
                           leave_stack=leave_stack_html
                           )
